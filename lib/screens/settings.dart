...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    ...
    getSharedPreferences().then((sharedPreferences) {
      _userController.text = sharedPreferences.containsKey(prefUser)
          ? sharedPreferences.get(prefUser)
          : '';
      _passwordController.text = sharedPreferences.containsKey(prefPassword)
          ? sharedPreferences.get(prefPassword)
          : '';
